...
public class GGLogoTween : MonoBehaviour {
    ...
    void OnEnable()
    {
        ...
        switch (buttonTween)
        {
            ...
            case Tweenbuttons.bringToDown:
                Invoke("loadSplashScreen", 3.0f);
                transform.Translate(0, -60, 0);
                iTween.MoveTo(gameObject, iTween.Hash("position", startPos, "time", 2.0, "isLocal", true, "easetype", iTween.EaseType.linear));
                break;

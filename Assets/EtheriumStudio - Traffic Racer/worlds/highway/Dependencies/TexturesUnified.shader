Shader "EtheriumShaders/ShaderModel2/MobileLM/Etherium Textures for Mobile" {
Properties {
...
CGPROGRAM
#pragma surface surf Etherium exclude_path:prepass noforwardadd
#pragma exclude_renderers xbox360 ps3
inline fixed4 LightingEtherium (SurfaceOutput s, fixed3 lightDir, fixed atten)
{

...
public class LevelSelLoadSpin : MonoBehaviour {
    ...
    void OnEnable()
    {
        ...
        switch (buttonTween)
        {
            ...
            case Tweenbuttons.slideToRightSideFast:
                ...
                iTween.MoveTo(gameObject, iTween.Hash("position", startPos, "time", 0.3, "isLocal", true, "easetype", iTween.EaseType.easeInOutBack));
                if (SoundController.Static != null)
                {
                    SoundController.Static.PlaySlider();
                }
